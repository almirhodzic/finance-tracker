<template>
  <div class="grid grid-cols-2 py-2 border-b border-gray-200 dark:border-gray-800 text-gray-900 dark:text-gray-100">
...
const iconColor = computed(() => isIncome.value ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-500')
